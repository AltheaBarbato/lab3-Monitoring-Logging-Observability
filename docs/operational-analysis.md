...
The systemd unit state metric (`node_systemd_unit_state`) shows whether fail2ban is running. If someone managed to stop it (or it crashed), the dashboard would show the fail2ban service as inactive — you'd know your defense layer was down.
